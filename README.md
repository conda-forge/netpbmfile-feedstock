...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/netpbmfile-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15477&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/netpbmfile-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `netpbmfile` can be installed with:

```
conda install netpbmfile
```

It is possible to list all of the versions of `netpbmfile` available on your platform with:
